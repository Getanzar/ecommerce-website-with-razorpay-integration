...
class GroceryMarketplaceTests(TestCase):
    def setUp(self):
        ...
        self.store = GroceryStore.objects.create(seller=seller, name="Local Kirana", address="Main Market", phone="9999999999", delivery_fee=20)
    ...
    def test_checkout_creates_order_and_reduces_stock(self):
        ...
        response = self.client.post(reverse("grocery_checkout"), {"full_name": "Test Customer", "phone": "9999999999", "address": "Market Road", "city": "Sahaswan", "state": "Uttar Pradesh", "pincode": "243638", "substitution_preference": "contact", "payment_method": "cod"})
    ...
    def test_cart_rejects_products_from_another_store(self):
        ...
        other_store = GroceryStore.objects.create(seller=seller, name="Other Store", address="Other", phone="8888888888")
